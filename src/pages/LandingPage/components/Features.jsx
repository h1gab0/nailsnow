      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="feature-card p-8 rounded-2xl reveal">
            ...
            <p className="mb-6">Sistema automatizado de citas que permite a tus clientes reservar 24/7, reduce no-shows y optimiza la disponibilidad de tu equipo.</p>
          ...
          <div className="feature-card p-8 rounded-2xl reveal">
            ...
            <p className="mb-6">Mantén un control preciso de tus productos y suministros con alertas automáticas para reabastecer antes de agotarse.</p>
            <ul className="text-sm space-y-2">
          ...
          <div className="feature-card p-8 rounded-2xl reveal">
            ...
            <p className="mb-6">Obtén insights valiosos sobre el rendimiento de tu negocio con reportes detallados de ingresos, gastos y rentabilidad.</p>
            <ul className="text-sm space-y-2">
          ...
          <div className="feature-card p-8 rounded-2xl reveal">
            ...
            <p className="mb-6">Crea perfiles detallados de tus clientes, registra sus preferencias y mejora su experiencia con un servicio personalizado.</p>
            <ul className="text-sm space-y-2">
          ...
          <div className="feature-card p-8 rounded-2xl reveal">
            ...
            <p className="mb-6">Atrae nuevos clientes y fideliza a los existentes con campañas de marketing integradas y cupones personalizados.</p>
            <ul className="text-sm space-y-2">
          ...
          <div className="feature-card p-8 rounded-2xl reveal">
            ...
            <p className="mb-6">Sitio web personalizado con chatbot integrado para resolver dudas y promocionar tus servicios las 24 horas del día.</p>
            <ul className="text-sm space-y-2">

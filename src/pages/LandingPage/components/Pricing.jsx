      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16 reveal">
          ...
          <div className="flex items-center justify-center space-x-4 mb-12">
            ...
            <span>Anual (2 meses gratis)</span>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div className="pricing-card p-8 rounded-2xl">
            <div className="text-center mb-8">
              ...
              <p className="mb-6">Perfecto para salones que comienzan</p>
              <div className="mb-6">
                <span className="font-display text-4xl font-medium" id="free-price">Gratis</span>
              </div>
            </div>
            <ul className="space-y-4 mb-8">
              <li className="flex items-center"><svg className="text-primary-green mr-3 w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"></path></svg><span>Agendamiento básico</span></li>
          ...
          <div className="pricing-card featured p-8 rounded-2xl relative">
            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2"><span className="bg-primary-green text-white px-6 py-2 rounded-full text-sm font-medium">Más Popular</span></div>
            <div className="text-center mb-8">
              <h3 className="font-display text-2xl font-medium mb-2">Nails Now Pro</h3>
              <p className="mb-6">Para salones que quieren crecer</p>
              <div className="mb-6">
